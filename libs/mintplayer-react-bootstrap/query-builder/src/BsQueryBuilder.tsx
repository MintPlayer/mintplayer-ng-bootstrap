...
export const BsQueryBuilder = createComponent({
  ...
  events: {
    ...
    onSortByChange: 'sort-by-change' as EventName<CustomEvent<SortDescriptor[]>>,
    onSelectedFieldsChange: 'selected-fields-change' as EventName<CustomEvent<string[]>>,
    onRootEntityChange: 'root-entity-change' as EventName<CustomEvent<string>>,
  },
});
