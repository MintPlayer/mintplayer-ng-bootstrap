...
@Component({
  ...
  imports: [NgTemplateOutlet, FormsModule, BsHasOverlayComponent, BsDropdownDirective, BsDropdownToggleDirective, BsDropdownMenuDirective, BsCheckboxComponent, BsButtonTypeDirective],
