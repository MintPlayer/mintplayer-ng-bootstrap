...
export class BsAccordionTabComponent {
  ...
  accordionTabId$ = new BehaviorSubject<number>(++this.accordion.accordionTabCounter);
  accordionTabName$ = combineLatest([this.accordion.accordionName$, this.accordionTabId$])
