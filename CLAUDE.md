...
- **No backticks inside a CSS comment inside a `css\`\`` template** — they terminate the JS template literal and the build fails somewhere confusing. Use bare names in CSS comments.
