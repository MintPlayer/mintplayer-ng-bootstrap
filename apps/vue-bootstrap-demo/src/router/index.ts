...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/datetime-picker', name: 'datetime-picker', component: () => import('../views/DatetimePickerView.vue') },
    { path: '/timepicker', name: 'timepicker', component: () => import('../views/TimepickerView.vue') },
    { path: '/checkbox', name: 'checkbox', component: () => import('../views/CheckboxView.vue') },
    { path: '/radio', name: 'radio', component: () => import('../views/RadioView.vue') },
    { path: '/toggle-button', name: 'toggle-button', component: () => import('../views/ToggleButtonView.vue') },
    { path: '/pagination', name: 'pagination', component: () => import('../views/PaginationView.vue') },
    { path: '/treeview', name: 'treeview', component: () => import('../views/TreeviewView.vue') },
    { path: '/tab-control', name: 'tab-control', component: () => import('../views/TabControlView.vue') },
    { path: '/code-snippet', name: 'code-snippet', component: () => import('../views/CodeSnippetView.vue') },
    // Advanced
