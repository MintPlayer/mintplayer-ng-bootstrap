    ...
    <div className="demo-page">
      ...
      <section>
        ...
        <ul>
          ...
          <li><Link to="/basic/datepicker">Datepicker</Link> — date input with v-model-equivalent controlled binding</li>
          <li><Link to="/basic/card">Card</Link> — composable card primitives</li>
          <li><Link to="/basic/code-snippet">Code snippet</Link> — syntax-highlighted source with copy-to-clipboard</li>
        </ul>
      </section>
    </div>
  );
