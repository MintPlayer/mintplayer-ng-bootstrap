...
@Component({
  ...
  standalone: true,
  imports: [DecimalPipe, FormsModule, BsGridModule, BsButtonTypeDirective, BsButtonGroupComponent, BsColorPickerModule, BsToggleButtonComponent, BsRangeModule, BsListGroupModule]
})
