...
@Component({
  ...
  imports: [DecimalPipe, FormsModule, BsGridModule, BsButtonTypeDirective, BsButtonGroupComponent, BsColorPickerComponent, BsToggleButtonModule, BsRangeModule, BsListGroupModule]
})
