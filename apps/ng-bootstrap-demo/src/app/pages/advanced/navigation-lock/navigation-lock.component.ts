...
@Component({
  ...
  imports: [FormsModule, BsForDirective, BsFormComponent, BsFormControlDirective, BsGridComponent, BsGridRowDirective, BsGridColumnDirective, BsColFormLabelDirective, BsCheckboxComponent, BsNavigationLockDirective],
