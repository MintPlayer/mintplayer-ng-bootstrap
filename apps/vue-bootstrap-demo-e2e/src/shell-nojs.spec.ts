...
// The Vue demo's whole layout is <mp-shell> (App.vue). This proves the sidebar
// + hamburger toggle work with JavaScript fully disabled: the WC never upgrades
// — the server-rendered Declarative Shadow DOM attaches at parse time and a
// pure-CSS checkbox state machine does the toggling. Runs against the SSR server
// (see playwright.config webServer).
